...
from electrum.bolt12 import BOLT12Offer, BOLT12InvoiceRequest, BOLT12Invoice, Bolt12InvoiceError
...
class TestLNWallet(ElectrumTestCase):
    ...
    async def test__verify_bolt12_invoice_requested_by_us(self):
        ...
        other_wallet = self.create_mock_lnwallet(name='other_wallet', has_anchors=True)
