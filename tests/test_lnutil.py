...
from electrum.lnutil import (
    ...
    ImportedChannelBackupStorage, list_enabled_ln_feature_bits, PaymentFeeBudget, FeeBudgetExceeded,
)
...
class TestLNUtil(ElectrumTestCase):
    ...
    async def test_payment_fee_budget(self):
        ...
        # test substract_blinded_path_fees
        ...
        remaining = budget.substract_blinded_path_fees(payinfo, amount_msat=100_000)
        ...
        with self.assertRaises(FeeBudgetExceeded):
            small_budget.substract_blinded_path_fees(payinfo, amount_msat=100_000)
