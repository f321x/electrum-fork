...
class Peer(Logger, EventListener):
    ...
    async def on_open_channel(self, payload):
        ...
        if channel_opening_fee:  # just-in-time channel opening
            ...
            if channel_opening_fee_sat > funding_sat * 0.1:  # TODO: make this config var
                # TODO: provider could tell us about fee upfront in init message so we can show it in the GUI
                #  or we require user interaction to accept the incoming channel, however this might time out this open request
