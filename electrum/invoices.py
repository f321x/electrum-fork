...
class BaseInvoice(StoredObject):
    ...
    def from_bolt12_invoice(cls, bolt12_invoice_bech32: str) -> 'Invoice':
        ...
        timestamp = bolt12_invoice.invoice_created_at
        exp_delay = bolt12_invoice.invoice_relative_expiry or 0
        message = bolt12_invoice.offer_description or ''
...
class Invoice(BaseInvoice):
    ...
    def bolt12_invoice(self):
        """Returns decoded bolt12 invoice, or None if this is not a bolt12 invoice."""
